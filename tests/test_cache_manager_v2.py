...
class TestCacheManager:
    ...
    def test_init_creates_tables(self, cache_db) -> None:
        assert cache_db is not None

    def test_update_and_get(self, cache_db) -> None:
    ...
    def test_get_expired_returns_none(self, cache_db) -> None:
    ...
    def test_mark_as_seen_idempotent(self, cache_db) -> None:
        cache_db.mark_as_seen("news", "item1")
        cache_db.mark_as_seen("news", "item1")  # Should not raise
        assert cache_db.is_duplicate("news", "item1") is True

    def test_clear_old_seen_items(self, cache_db) -> None:
    ...
    def test_different_categories(self, cache_db) -> None:
