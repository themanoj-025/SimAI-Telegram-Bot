# AI-Telegram-News-Bot — Documentation Index

Single home for all AI-Telegram-News-Bot documentation. The bot aggregates an
AI/ML news digest (GitHub Trending, arXiv, X) and posts it to Telegram as a
daily brief.
...
├── startup_flow.md                boot + digest flow
├── community/
...
| You want... | Read |
|---|---|
| How the bot works end-to-end | [architecture.md](architecture.md) |
